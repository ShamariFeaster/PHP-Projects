							...
							if($flag == 0){ //inner if 2
								...
								if(pt($username,$password,$holder)){
									...
									unset($status_code);
										...
										$json_hdr['error_msg'] .=  "<br />Attempted to send tweet at ".date('h:i:s A').//b
										" failed. Reason: ".$error_msg.
										" Returned status code: ".$status_code."<br />";
										...
										if($status_code=="403" or $status_code=="401"){
											if($login_array){
												...
												$login_cnt++;
												$json_hdr['new_acc'] .= "<br /><strong>Switched to @".$username." account</strong>";
